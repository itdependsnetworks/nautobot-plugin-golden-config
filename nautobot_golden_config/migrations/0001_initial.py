# Generated by Django 3.1.8 on 2021-05-03 03:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platform', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='compliance_features', to='dcim.platform')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('device', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dcim.device')),
                ('name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feature', to='nautobot_golden_config.compliancefeature')),
                ('tags', taggit.managers.TaggableManager(through='extras.TaggedItem', to='extras.Tag')),
            ],
            options={
                'ordering': ['device'],
